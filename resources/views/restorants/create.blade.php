@extends('layouts.app', ['title' => __('Chef Management')])

@section('content')
    @include('restorants.partials.header', ['title' => __('Add Chef')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Chef Management') }}</h3>
                            </div>
                        ...
                        <div class="pl-lg-4">
                            <form method="post" action="{{ route('admin.restaurants.store') }}" autocomplete="off">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Chef Name here') }} ..." value="" required autofocus>
                                    @if ($errors->has('name'))
